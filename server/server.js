...
function askGemini(text, duration) {
  return new Promise((resolve) => {
    ...
    const prompt = `당신은 명상 후 마음을 돌보는 파트너입니다. 아래는 ${duration}분 명상을 마친 후 적은 마음일기입니다. 다음 세 가지 중 가장 적합한 한 가지를 골라 응답하세요.

1. **보충** — 느낀 감정이나 생각을 더 깊이 이해할 수 있는 관점 추가
2. **사례** — 비슷한 감정이나 상태를 경험한 사람들의 이야기나 명상 전통의 지혜
3. **결합** — 이 마음 상태에서 시도하면 좋을 다음 실천이나 연결 아이디어

응답 형식: 유형을 먼저 한 단어로(예: "보충:" / "사례:" / "결합:"), 이어서 2~3문장. 따뜻하고 친근한 한국어로.
